...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_agents", type=str, default="two", help='Choose "single" for single bot or "two" for two agents.')
    ...
    parser.add_argument(
        "--player1_race", type=str, default="Protoss", help='Player 1 race. Use "Protoss" or "Zerg". Only valid for two agents.'
    )
    ...
    parser.add_argument(
        "--agent1_type", type=str, default="random", help='Agent type. Use "random" or "llama2" or "glm2" or "gpt"'
    )
    parser.add_argument(
        "--agent2_type", type=str, default="random", help='Agent type. Use "random" or "llama2" or "glm2" or "gpt"'
    )
    parser.add_argument(
        "--replay_folder",
        type=str,
