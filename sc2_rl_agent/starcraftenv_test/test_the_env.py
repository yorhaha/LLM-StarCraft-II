...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_agents", type=str, default="single", help='Choose "single" for single bot or "two" for two agents.'
    )
    ...
    parser.add_argument(
        "--player_race", type=str, default="Protoss", help='Player race. Use "Protoss" or "Zerg". Only valid for single bot.'
    )

    parser.add_argument(
        "--opposite_race", type=str, default="Zerg", help='Opponent race. Use "Protoss" or "Zerg". Only valid for single bot.'
    )
    ...
    parser.add_argument(
        "--player1_race", type=str, default="Zerg", help='Player 1 race. Use "Protoss" or "Zerg". Only valid for two agents.'
    )

    parser.add_argument(
        "--player2_race", type=str, default="Protoss", help='Player 2 race. Use "Protoss" or "Zerg". Only valid for two agents.'
    )

    parser.add_argument(
        "--process_id", type=str, default="-1", help="-1 means not multiprocess worker" "0-100 means multiprocess id."
    )
    parser.add_argument(
        "--current_time",
        type=str,
    ...
    parser.add_argument(
        "--agent_type", type=str, default="llama2", help='Agent type. Use "random" or "llama2" or "glm2" or "chatgpt"'
    )
